...
## Preview Setup
The dashboard is currently running entirely in static design preview mode. It loads simulated alerts on startup from [sampleData.js](file:///d:/downloads/zero-day/dashboard/sampleData.js) and displays them inside the interactive timeline chart, metric summary counts, and the real-time threat feed table.
